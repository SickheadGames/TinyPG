...
namespace TinyPG
{
    ...
    public class TextHighlighter : IDisposable
    {
        ...
        {
            ParseTree _tree = (ParseTree)Parser.Parse(Textbox.Text);
            lock (treelock)
            {
                Tree = _tree;
            }
            HighlightTextInternal();
        }
        ...
        {
            sb.Insert(0, @"{\rtf1\ansi\deff0{\fonttbl{\f0\fnil\fcharset0 Consolas;}}{\colortbl;\red0\green0\blue255;}\viewkind4\uc1\pard\lang1033\f0\fs20");
        }
